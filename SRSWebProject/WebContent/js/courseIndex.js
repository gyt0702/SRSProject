...
$(document).ready(function(){
		$.getJSON("GetAllCourses",function(json){
			...
			for(var i=0;i<json.length;i++){
				...
				html+="<td><button class='btn btn-default'style=\"background:#888;border:1px solid #888;color:#ccc\" id='modal-858342' href='#modal-container-858342' role='button' data-toggle='modal' onclick=\"showSections('"+json[i].courseNo+"','"+json[i].courseName+"');\">";
